...
export type ContractContext = EthersContractContextV5<PoolCrossChainL0, PoolCrossChainL0MethodNames, PoolCrossChainL0EventsContext, PoolCrossChainL0Events>;
...
export type PoolCrossChainL0Events =
  | 'AssetAdded'
  | 'CrossChainSwap'
  | 'Deposit'
  | 'DevUpdated'
  ...
  | 'Unpaused'
  | 'Withdraw';
export interface PoolCrossChainL0EventsContext {
...
export type PoolCrossChainL0MethodNames =
  | 'new'
  | 'addAsset'
  | 'assetOf'
  | 'c1'
